...
using Blex.ModelsHelper.PayPal;
using PayPal.Api;

namespace Blex.Controllers
{
    public class PaymentController : Controller
    {
        ...
        public ActionResult PaymentWithCreditCard()
        {
            ...
            billingAddress.city = "Dortmund";
            billingAddress.country_code = "DE";
            ...
            crdtCard.first_name = "Hatem";
            crdtCard.last_name = "Hamad";
            crdtCard.number = "6011111111111117";
        ...
        private Payment CreatePayment(APIContext apiContext, string redirectUrl)
        {
            ...
            transactionList.Add(new Transaction()
            {
                ...
                invoice_number = new Random().Next().ToString(),
                amount = amount,
                item_list = itemList
            });
